...
if __name__ == "__main__":
    path_ls = ['src/evaluate/generate_plot/src_csv/0611-1556_BadmintonNet_BS-15_Adam1.00e-04_Side2']
    # path_ls = ['src/plot/src_csv/0611-1556_BadmintonNet_BS-15_Adam1.00e-04_Side2', 'src/plot/src_csv/0611-1558_BadmintonNet_BS-15_Adam1.00e-04_Side3Handcraft']
    generate_plot(path_ls, 'src/evaluate/generate_plot/plot_output', 2)
